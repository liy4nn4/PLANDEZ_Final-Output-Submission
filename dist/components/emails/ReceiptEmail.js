...
var ReceiptEmail = function (_a) {
    ...
    return (React.createElement(components_1.Html, null,
        ...
        React.createElement(components_1.Preview, null, "Your SVELTE Order Receipt"),
        React.createElement(components_1.Body, { style: main },
            React.createElement(components_1.Container, { style: container },
                React.createElement(components_1.Section, null,
                    React.createElement(components_1.Column, null,
                        React.createElement(components_1.Img, { src: "".concat(process.env.NEXT_PUBLIC_SERVER_URL, "/hippo-email-sent.png"), width: '100', height: '100', alt: 'SVELTE' })),
                ...
                React.createElement(components_1.Section, null,
                    ...
                    React.createElement(components_1.Column, { style: { paddingLeft: '40px', paddingTop: 20 } },
                        React.createElement(components_1.Text, { style: productTitle }, "Shipping Fee")),
                    React.createElement(components_1.Column, { style: productPriceWrapper, align: 'right' },
